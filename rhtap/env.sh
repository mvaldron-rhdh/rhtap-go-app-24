...
export IMAGE_URL=${IMAGE_URL-quay.io/mvaldron-rhdh/rhtap-go-app-24:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/mvaldron-rhdh/rhtap-go-app-24-gitops
